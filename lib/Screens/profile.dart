                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: InkWell(
                          onTap: isUpdatingProfile ? null : handleSaveChanges,
                          ...
                          child: Ink(
                            decoration: BoxDecoration(
                              ...
                              color: isUpdatingProfile ? Colors.grey : null,
                            ),
                            child: SizedBox(
                              height: 45,
                              child: Center(
                      ...
                      Expanded(
                        child: InkWell(
                          onTap: isLoggingOut ? null : handleLogout,
                          borderRadius: BorderRadius.circular(10),
                          child: Ink(
                            decoration: BoxDecoration(
                              gradient: const LinearGradient(
                              ...
                              color: isLoggingOut ? Colors.grey : null,
                            ),
                            child: SizedBox(
                              height: 45,
                              child: Center(
